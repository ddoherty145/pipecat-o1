...
class BamlSyncClient:
    ...
    def CustomerSupport(self, request: types.CustomerSupportRequest,
        ...
        result = self.__options.merge_options(baml_options).call_function_sync(function_name="CustomerSupport", args={
            "request": request,
        })
...
class BamlStreamClient:
    ...
    def CustomerSupport(self, request: types.CustomerSupportRequest,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.CustomerSupportResponse, types.CustomerSupportResponse]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="CustomerSupport", args={
            "request": request,
        })
        return baml_py.BamlSyncStream[stream_types.CustomerSupportResponse, types.CustomerSupportResponse](
          result,
...
class BamlHttpRequestClient:
    ...
    def CustomerSupport(self, request: types.CustomerSupportRequest,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="CustomerSupport", args={
            "request": request,
        }, mode="request")
        return result
    def ExtractResume(self, resume: str,
