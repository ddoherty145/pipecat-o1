...
class BamlAsyncClient:
    ...
    async def CustomerSupport(self, request: types.CustomerSupportRequest,
        baml_options: BamlCallOptions = {},
    ) -> types.CustomerSupportResponse:
        result = await self.__options.merge_options(baml_options).call_function_async(function_name="CustomerSupport", args={
            "request": request,
        })
        return typing.cast(types.CustomerSupportResponse, result.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def CustomerSupport(self, request: types.CustomerSupportRequest,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.CustomerSupportResponse, types.CustomerSupportResponse]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="CustomerSupport", args={
            "request": request,
        })
        return baml_py.BamlStream[stream_types.CustomerSupportResponse, types.CustomerSupportResponse](
          result,
          lambda x: typing.cast(stream_types.CustomerSupportResponse, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.CustomerSupportResponse, x.cast_to(types, types, stream_types, False, __runtime__)),
          ctx,
        )
...
class BamlHttpRequestClient:
    ...
    async def CustomerSupport(self, request: types.CustomerSupportRequest,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="CustomerSupport", args={
            "request": request,
        }, mode="request")
        return result
    async def ExtractResume(self, resume: str,
